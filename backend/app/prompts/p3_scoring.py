...
⚠️ 对话进展感知（最重要！）：
- 你必须阅读完整对话历史，理解对话的情绪弧线和权力动态
- 早期轮次：双方还在试探，建议可以轻松试探
- 中期轮次：矛盾已经暴露，建议要有针对性化解
- 后期轮次：双方可能已经对峙，建议要能破局收场
- 如果对话已经升级到对抗/争吵状态，风格人物的回应不能还在"温柔开场"——必须匹配当前紧张度
- 简单说：看对话走到了哪里，再决定怎么建议，不要当第一轮来建议
"""
...
⚠️ 风格参考答案必须追踪对话进展（关键！）：
- 先看对话历史，判断当前对话的情绪温度（平和/微热/激烈/对峙）
- 风格人物的回应必须匹配当前对话阶段，不能还停留在第一轮的轻松语气
- 举例：如果双方已经在争吵，黄渤不能建议"自嘲一下"——应该建议怎么在冲突中破局
- 举例：如果对方已经被说服大半，何炅不用再"先接后引"——可以建议怎么收场
- 1-2 句口语，风格人物会用的话，不是教科书
